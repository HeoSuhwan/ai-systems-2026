...
<Badge text="중급" variant="tip" /> <Badge text="마감: 2026-04-14" variant="note" />
...
<div class="diagram">
  <div class="diagram__chain">
    <div class="diagram__node diagram__node--red">
      <span class="diagram__node__label">harness.log 분석</span>
    </div>
    <div class="diagram__arrow">&#x2193;</div>
    <div class="diagram__node diagram__node--orange">
      <span class="diagram__node__label">오류 패턴 추출</span>
    </div>
    <div class="diagram__arrow">&#x2193;</div>
    <div class="diagram__node diagram__node--blue">
      <span class="diagram__node__label">PROMPT.md 수정</span>
    </div>
    <div class="diagram__arrow">&#x2193;</div>
    <div class="diagram__node diagram__node--cyan">
      <span class="diagram__node__label">A/B 테스트</span>
    </div>
    <div class="diagram__arrow">&#x2193;</div>
    <div class="diagram__node diagram__node--green">
      <span class="diagram__node__label">반복</span>
    </div>
  </div>
</div>
