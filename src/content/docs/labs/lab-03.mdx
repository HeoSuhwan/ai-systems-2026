...
<div class="diagram">
  <div class="diagram__chain">
    ...
    <div class="diagram__node diagram__node--cyan">
      <span class="diagram__node__label">MCP 서버</span>
    </div>
    <div class="diagram__arrow">&#x2193;</div>
...
- **Codex CLI**: 미지원 — MCP 실습은 Claude Code 또는 Gemini CLI로 진행할 것
- **OpenCode**: 제한적 지원
</Aside>
...
MCP 서버는 AI 코딩 에이전트에게 강력한 권한을 부여한다. 프로덕션 환경에서는 허용 경로와 실행 가능 명령을 최소한으로 제한할 것.
</Aside>
