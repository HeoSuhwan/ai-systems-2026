...
### Part 3: Claude Code 권한 모델 — HOTL의 실제 구현
...
### Part 4: 규제 프레임워크 — EU AI Act와 한국 AI 기본법
...
### Part 6: Governance-as-Code 설계 스택
...
- [Pillar Security: Rules File Backdoor](https://www.pillar.security/blog/new-vulnerability-in-github-copilot-and-cursor) — Copilot/Cursor 설정 파일 공격 상세 분석
...
- [NIST AI RMF Playbook](https://airc.nist.gov/AI_RMF_Playbook) — 관리 프레임워크 실행 가이드
